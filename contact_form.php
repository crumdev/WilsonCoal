...
<div id="main_content">
        <a href="#" id="click_me"><h1>Contact Us</h1></a>
    ...
    <div id="form" class="cf">
	    <form id="contact-form" action="/" method="POST">
	        ...
	        <span id="contact-info">
	            <p><label for="name">*Name:</label><input type="text" name="name" id="name" class="required"/></p>
			...
			<span id="product-info">
				...
				<p><label for="fireplace">Do you have a fireplace?</label>
					...
					<input type="radio" name="fireplace" id=""/>no</p>
			</span>
			
			<label for="message"><p>Message:</p></label><textarea class="required" name="message" rows="10" cols="60"></textarea>
...
<script type="text/javascript"> 
	$(document).ready(function() {
		...
		*/
		$('#contact-form').find('input, select').blur(function() { 
			var badEmail = false;
			var empty = false;
			$('#contact-form').find('input, select').filter('.required').each(function(){ 
				if($.trim($(this).val()) === '') {
					empty = true;
